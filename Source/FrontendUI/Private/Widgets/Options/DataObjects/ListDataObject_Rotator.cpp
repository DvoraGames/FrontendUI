...
void UListDataObject_Rotator::AddDynamicOption(const FString& InStringValue, const FText& InDisplayText)
{
...
void UListDataObject_Rotator::AdvanceToNextOption()
{
...
void UListDataObject_Rotator::BackToPreviousOption()
{
	// Aborta se não houver opções configuradas (String e Text) no carrossel
	if (AvailableOptionsStringArray.IsEmpty() && AvailableOptionsTextArray.IsEmpty()) return;
...
bool UListDataObject_Rotator::CanResetBackToDefaultValue() const
{
	// Só permite reset se há valor padrão definido e o valor atual é diferente dele
	return HasDefaultValue() && CurrentStringValue != GetDefaultValueAsString();
}

bool UListDataObject_Rotator::TryResetBackToDefaultValue()
{
...
bool UListDataObject_Rotator::TrySetDisplayTextFromStringValue(const FString& InStringValue)
{
